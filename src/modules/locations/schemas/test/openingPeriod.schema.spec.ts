...
describe('OpeningPeriodSchema', () => {
  describe('should return true if date is inside opening period', () => {
    it('basic one day period', () => {
      const period = new OpeningPeriod({ day: 1, time: '0900' }, { day: 1, time: '1700' });
    ...
    it('period over multiple days', () => {
      const period = new OpeningPeriod({ day: 1, time: '0900' }, { day: 3, time: '1700' });
      ...
      const period2 = new OpeningPeriod({ day: 0, time: '0730' }, { day: 1, time: '0100' });
      expect(period2.containsInside(getDateFromWeekDay(0, 7, 30))).toBe(true);
    });
    it('period over multiple days (module using)', () => {
      const period = new OpeningPeriod({ day: 5, time: '0900' }, { day: 3, time: '1700' });
